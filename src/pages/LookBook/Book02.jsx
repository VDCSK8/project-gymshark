...
import LookBook02Img1 from "../../assets/img/LookBook02Img1.png";
import LookBook02Img2 from "../../assets/img/LookBook02Img2.png";
import LookBook02Img3 from "../../assets/img/LookBook02Img3.png";
import LookBook02Img4 from "../../assets/img/LookBook02Img4.png";
    ...
    <main className={styles.LookBook}>
      <div className={styles.container}>
        <div className={styles.LookBook__content}>
          <h2 className={styles.LookBook__title}>ONYX RETURNS VER2</h2>
        ...
        <div className={styles.LookBook__gallery}>
          <img className={styles.LookBook__img} src={LookBook02Img1} alt="" />
          <img className={styles.LookBook__img} src={LookBook02Img2} alt="" />
          <img className={styles.LookBook__img} src={LookBook02Img3} alt="" />
          <img className={styles.LookBook__img} src={LookBook02Img4} alt="" />
        </div>
      </div><GoToTop />
    </main>
  );
